...
const Button = ({text, onClick, isMain, isNav}: Props) => {
    ...
    return (
        <button onClick={onClick} type="button" className={`${typeOfButton} focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xs px-5 py-2.5 mr-2 mb-2 focus:outline-none`}>
